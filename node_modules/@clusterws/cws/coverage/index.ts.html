...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">import * as HTTP from 'http';
...
&nbsp;
export const secureProtocol: string = 'TLSv1_2_method';</pre></td></tr></table></pre>
